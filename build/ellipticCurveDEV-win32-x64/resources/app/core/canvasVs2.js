...
let CanvasCreator = {
    ...
    getAndChangeDistance: function (_size, _countOfSeparations, _last) {
        let sep = _countOfSeparations / $(VAR_SPACE_SELECT).val();
    ...
    createGrid: function (_countOfSeparations) {
        ...
        for (let index = (distance + config.distance.padding + config.distance.axes);
             ...
             index += distance) {
            let space = ($(VAR_SPACE_SELECT).val() * count);
    ...
    markPoint: function (_index, _name) {
        ...
        canvas.drawDonut({
            layer: true,
            name: _name,
            fillStyle: (_name === 'R' ? config.color.result : ((_name === 'P' || indexP === indexQ) ? config.color.markP : config.color.markQ)),
            ...
            name: _name + 'text',
            fillStyle: (_name === 'R' ? config.color.result : ((_name === 'P' || indexP === indexQ) ? config.color.markP : config.color.markQ)),
            strokeStyle: (_name === 'R' ? config.color.result : ((_name === 'P' || indexP === indexQ) ? config.color.markP : config.color.markQ)),
            strokeWidth: config.width.text,
            x: (point['point'].pointX - config.font.size),
            y: (point['point'].pointY - config.font.size),
